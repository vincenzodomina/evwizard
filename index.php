...
<footer id="footer" class="footer-distributed">
		...
		<div class="footer-right">
			<p class="footer-company-about">
				<span>About EV Wizard</span>The easy to use and understand EV conversion calculation wizard with daily update service for the price of a drink!</p>
			<br>
			<p class="footer-company-about"> 
				<!--------  Day counter  ------------->
			  <?php $daysuntil=(int)((mktime(0,0,0,1,1,2017)-time())/86400); print"$daysuntil days until launch of EV Wizard website";?>
			</p>
